...
private WebDriver driver;
	...
	public void MakeTransfer() throws InterruptedException {
		...
		//(4)driver.findElement(By.xpath("//body/div[@id='menu-']/div[3]/ul[1]/li[3]")).click();
		...
		driver.findElement(By.id("outlined-basic")).sendKeys("68345373");
		Thread.sleep(1000);
		driver.findElement(By.id("demo-simple-select1")).click();
		driver.findElement(By.cssSelector(".MuiMenuItem-root:nth-child(4)")).click();
		Thread.sleep(1000);
		//driver.findElement(By.xpath("//body/div[@id='menu-']/div[3]/ul[1]/li[3]")).click();
		...
		//driver.findElement(By.xpath("//body/div[@id='root']/div[1]/div[3]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/input[1]")).sendKeys("2000");
		driver.findElement(By.cssSelector(".Mui-focused > #outlined-basic")).click();
		driver.findElement(By.cssSelector(".Mui-focused > #outlined-basic")).sendKeys("2000");
	...
	public static void main(String[] args) throws InterruptedException {
		...
		MultipleTransfer obj = new MultipleTransfer();
				obj.lunchBrowser();
				obj.login();
				obj.MakeTransfer();
				obj.CloseBrowser();
